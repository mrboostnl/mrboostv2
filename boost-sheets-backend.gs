/**
 * BOOST CRM — backend (Google Apps Script + Google Sheet)
 * Ontvangt leads van de Boost Scan, schrijft ze naar dit Spreadsheet,
 * levert ze terug aan het dashboard (/bh33r) en mailt optioneel Dennis.
 *
 * Zet NOTIFY op een e-mailadres als je per lead een mailtje wilt.
 */
